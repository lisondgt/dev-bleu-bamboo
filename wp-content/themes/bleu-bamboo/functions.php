<?php
/**
 * Bleu Bamboo functions and definitions
 *
...
if ( ! function_exists( 'bleu_bamboo_setup' ) ) :
	/**
	 ...
	 */
	function bleu_bamboo_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Bleu Bamboo, use a find and replace
		 * to change 'bleu-bamboo' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'bleu-bamboo', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'bleu-bamboo' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'bleu_bamboo_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'bleu_bamboo_setup' );
 ...
 */
function bleu_bamboo_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'bleu_bamboo_content_width', 640 );
}
add_action( 'after_setup_theme', 'bleu_bamboo_content_width', 0 );
 ...
 */
function bleu_bamboo_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'bleu-bamboo' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'bleu-bamboo' ),
 ...
 */
function bleu_bamboo_scripts() {
	wp_enqueue_style( 'bleu-bamboo-style', get_stylesheet_uri(), array(), _S_VERSION );
