...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<h5><?php esc_html_e( 'En résumé...', 'woocommerce' ); ?></h5>

	<div class="shop_table shop_table_responsive">

		<div class="cart-subtotal">
			<div><?php esc_html_e( 'Sous total', 'woocommerce' ); ?></div>
			<div data-title="<?php esc_attr_e( 'Sous total', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></div>
		</div>
		...
		<div class="order-total">
			...
			<div class="total-price" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?></div>
		</div>

        <div class="code-promo">
            <p>Pas de panique si tu as un code promo ! Tu pourras l’ajouter plus tard :)</p>
        </div>
...
<div class="moyen-de-paiement">
    <p>Nous acceptons les moyens de paiement suivants :</p>
    <div class="container-logos-paiement">
        <img src="../wp-content/themes/bleu-bamboo/images/pictos/visa.jpg" class="visa"/>
        <img src="../wp-content/themes/bleu-bamboo/images/pictos/mastercard.jpg" class="mastercard"/>
        <img src="../wp-content/themes/bleu-bamboo/images/pictos/paypal.jpg" class="paypal"/>
        <img src="../wp-content/themes/bleu-bamboo/images/pictos/cb.jpg" class="cb"/>
    </div>
</div>
