...
<div class="container">
    <div class="content-title">
        <p class="up-titre">TON SUPER PANIIER</p>
        <h2>Tu n’es plus qu’à un clic de <span class="handwriting">changer le monde !</span></h2>
    </div>
    <div class="row">
                        ...
                        <div class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                            ...
                            <div class="col-right">
                                ...
                                <div class="quantity-and-remove">
                                    ...
                                    <!--                            <div class="product-subtotal" data-title="-->
                                    ...
                                    <div class="product-remove">
                                        ...
                                        echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                            ...
                                            sprintf(
                                                '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">Supprimer ce produit</a>',
